...
@section('content')
    <div class="container">
            ...
            <div class="col-md-12">
                <table class="table table-bordered table-striped">
                    <thead class="thead-default">
                        <tr>
                            <th><h3 style="display: inline-block;">Deliveries</h3>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse($delivery->files as $file)
                            <tr>
                                <td>
                                    ...
                                    <a href="{{url('admin/deliveries/'.$delivery->id.'/file/'.$file->id.'/delete')}}" class="btn btn-danger pull-right">Delete</a>
                                </td>
                            </tr> 
                        @empty
                            <tr>
        ...
        <div class="row">
            <div class="col-md-12">
                <h3>Upload Files</h3>
                <form enctype="multipart/form-data" method="POST" action="{{url('admin/deliveries/'.$delivery->id.'/upload')}}"> 
                    {!! csrf_field() !!}
